...
class MaintenanceRepository implements MaintenanceInterface
{
    ...
    {
        // dd($post_data);
        return MaintenanceEngineer::create(["active"=>true,"name" => $post_data["search_maintenance_engineer_name"],"maintenance_agent_id" => $post_data["maintenance_agent_name"], "maintenance_schedule_id" => $post_data["maintenance_schedule"], "tower_id" => $post_data["add_maintenance_tower"]]);
    }
