...
@section('contenta')
    <div class="block">
        ...
        <div class="block-content">
            ...
            @endif
            <form action="{{ route('menus.store') }}" method='POST' class="@if ($errors->any()) was-valdated @endif">
                @csrf
                ...
                <div class="form-group row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-material floating">
                            <input id="folder" type="text" class="form-control @error('folder') is-invalid @enderror" name="folder" value="{{ old('folder') }}" autocomplete="off">
