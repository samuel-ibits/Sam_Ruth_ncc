...
<html lang="en" class="no-focus">
    <head>
        ...
        <title>Login - National Central Tower</title>
                ...
                <div class="bg-image" style="background-image: url({{asset('media/photos/photo34@2x.jpg')}});">
                    ...
                    <form method="POST" id="LoginForm" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control @error('email') is-invalid @enderror @error('username') is-invalid @enderror" name="identity" value="{{ old('identity') }}" autofocus>
