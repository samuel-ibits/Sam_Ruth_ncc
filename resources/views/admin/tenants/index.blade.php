...
@section('content')
    <!-- Page Content -->
    <div class="content">
        <h2 class="content-heading">Tenants <small>view tenants</small></h2>
         <!-- Full Table -->
         <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">List of tenants</h3>
            </div>
...
<script>
 ...
 },
 {
   ...
   "TOWER STATUS": "ACTIVE",
   "NO. OF ANTENNA": 4,
   "TENANTS": "AIRTEL, AIRTEL, SPECTR, 9MO"
 },
 {
   "TOWER NAME": "AXE",
   "Tower Owner": "PAT",
 ...
 },
 {
   ...
   "TENANTS": ""
        ...
        const head = Object.keys(tenants[0]);
        //console.log(head);
...
const convertDateFormat = (date)=>{
    ...
    return `${dateParts[1]}/${dateParts[0]}/${dateParts[2]}`;
        ...
        const bodyList = tenants.map(addTableBody);
