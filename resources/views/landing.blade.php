                ...
                <div class="content content-full text-center">
                    <div class="pt-100 pb-150">
                        <h1 class="font-w700 display-4 mt-20 invisible" data-toggle="appear" data-timeout="50">
                            <span class="text-primary font-w300">National Central Tower Portal by the Nigerian Communications Commission</span><span class="font-w300"></span>
                        </h1>
                        <h2 class="h3 font-w400 text-muted mb-50 invisible" data-toggle="appear" data-class="animated fadeInDown" data-timeout="300">Empowered by the Nigerian Communications Act 2003.</h2>
                        <div class="invisible" data-toggle="appear" data-class="animated fadeInDown" data-timeout="300">
                            @guest
                            <a class="btn btn-hero btn-noborder btn-success min-width-175 mb-10 mx-5" href="{{ route('login') }}">
                                <i class="fa fa-fw fa-arrow-right mr-1"></i> Enter Dashboard
                            </a>
                            @else
                                <a class="btn btn-hero btn-noborder btn-success min-width-175 mb-10 mx-5" href="{{ route('dashboards') }}">
                                <i class="fa fa-fw fa-arrow-right mr-1"></i> Enter Dashboard
                            </a>
                            @endguest
                        </div>
